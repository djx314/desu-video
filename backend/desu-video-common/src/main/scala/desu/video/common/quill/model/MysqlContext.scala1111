...
import io.getquill.{MySQLDialect, MysqlJAsyncContext, SnakeCase}
import scala.concurrent.ExecutionContext
import zio._

object MysqlContext extends MysqlJAsyncContext[SnakeCase](SnakeCase, "mysqlDesuDBQuill") with DesuVideoExtensions[MySQLDialect, SnakeCase] {
