...
case class countPlan(id: Int, firstOuterName: String, firstOuterType: String, firstInnerName: String, firstInnerType: String, firstStart: Int, secondOuterName: String, secondOuterType: String, secondInnerName: String, secondInnerType: String, secondStart: Int, counterResultId: Option[Int])
